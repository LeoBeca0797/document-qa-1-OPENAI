...
if student_name:
    ...
    if parental_employment_status == "Basso" or urbanization_level == "Rurale":
        ...
        - **Benessere psicologico e relazionale**: Competenze come la resistenza allo stress, l'ottimismo e il controllo emotivo sono associate a un benessere psicologico migliore. Gli studenti con livelli più alti di queste competenze tendono a sperimentare meno ansia in classe e durante i test e a mantenere un'immagine corporea positiva (OCSE2023_Italy_1)(OECD_I Report).
        - Relazioni sociali positive e soddisfacenti sono più comuni tra studenti con elevate capacità di empatia e sociabilità. Queste competenze migliorano le interazioni con compagni di classe e insegnanti, rafforzando il senso di appartenenza e diminuendo il rischio di isolamento (OCSE2023_Italy_2)(OECD_II Report).
        - **Comportamenti salutari**: Gli studenti con maggiori abilità nella regolazione emotiva e nella resilienza allo stress tendono a intraprendere comportamenti più sani, come evitare il consumo di alcol e tabacco e praticare attività fisica regolarmente (OCSE2023_Italy_1)(OECD_I Report).
        - **Soddisfazione della vita**: L'ottimismo e l'energia sono fortemente correlati con una maggiore soddisfazione per la vita e una visione più positiva del futuro. Gli studenti che possiedono queste competenze affrontano meglio le sfide e mantengono un atteggiamento propositivo verso il raggiungimento dei propri obiettivi (OECD_I Report)(OECD_II Report).
        - **Equità e benessere tra i gruppi**: Tuttavia, esistono differenze significative nella distribuzione delle competenze socio-emotive tra studenti di diverso genere e background socio-economico, che possono influenzare il benessere. Ad esempio, gli studenti provenienti da contesti socio-economici svantaggiati spesso riportano livelli inferiori di fiducia, empatia e motivazione al successo, il che può avere impatti negativi sulla loro esperienza scolastica complessiva (OCSE2023_Italy_1)(OCSE2023_Italy_2).
